...
@section('content')
    ...
    <div class="container">
        <div class ="row justify-content-center">
            <div class="col-8">
                <div class="card">
                    <form action={{route('insertTask')}} method="POST" enctype="multipart/form-data">

                        @csrf
                        <div class="mb-3">
                            <label for="forTaskTitle" class="form-label">Task Title</label>
                            <input type="text" name="taskTitle" class="form-control" id="forTaskTitle">
                            @error('taskTitle')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            <label for="forTaskType">Details Type:</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="textarea" name="taskRemarks" class="form-control" id="forTaskRemarks">
                            @error('taskRemarks')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="taskDate" data-target-input="nearest">
                                <input type="text" name="taskTimeStart"class="form-control datetimepicker-input" data-target="#taskDate"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="taskDate" data-target-input="nearest">
                                <input type="text" name="taskTimeEnd" class="form-control datetimepicker-input" data-target="#taskDate"/>
                                <div class="input-group-append" data-target="#taskDate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="forTaskDesignation" name="taskDesignation">
                                @foreach($emp as $data)
